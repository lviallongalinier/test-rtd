...
This module gathers the classes to handle profile data. These classes are designed to be used in the :py:class:`snowprofile.snowprofile.SnowProfile` class.
	...
	- :py:class:`snowprofile.profiles.RamSondeProfile`
